// Funcional: src/app/shared/ui/filter-sidebar/filter-sidebar.component.ts ó descripciÛn breve de la responsabilidad principal del archivo.
...
export class FilterSidebarComponent {
  @Input() categories: string[] = ['Frutas', 'Verduras', 'Panader√≠a', 'L√°cteos', 'Caf√©'];
